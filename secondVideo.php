...
{
    document.getElementById("secicone").style.color="#50a33c";
    document.getElementById("sec").style.color="#50a33c";
}
</script>
    </head>
...
<iframe   id = "secondVideo" class ="vido body"    height="600"  src="https://www.youtube.com/embed/D0Ajq682yrA"></iframe> 
<button class="continueButton" onclick="window.location.href='Quiz1.php'"  >continue</button>
